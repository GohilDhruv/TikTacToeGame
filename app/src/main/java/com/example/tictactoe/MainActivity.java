...
public class MainActivity extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView,int selectedBoxPosition){
        ...
        if (playerTurn == 1){
            ...
            if (checkPlayerwin()){
              ...
              // winDialog.setCancelable(false);
               // winDialog.show();
                Toast.makeText(MainActivity.this,"its a drav",Toast.LENGTH_LONG).show();
                restartMatch();
            }
            else {
                changePlayerTurn(2);
            ...
            if (checkPlayerwin()) {
               // WinDialog winDialog = new WinDialog(MainActivity.this, playerTwoName.getText().toString() + "has won the match", MainActivity.this);
                //winDialog.setCancelable(false);
               // winDialog.show();
                Toast.makeText(MainActivity.this,playerTwoName.getText().toString() + " has won the match",Toast.LENGTH_LONG).show();
                restartMatch();
            }
    ...
    private void changePlayerTurn(int currentPlayerTurn){
        ...
        if (playerTurn == 1){
            playerOneLayout.setBackgroundResource(R.drawable.ruund_back_blue_border);
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_dark_blue);

        }
        else {
            playerTwoLayout.setBackgroundResource(R.drawable.ruund_back_blue_border);
